...
export default function AnnouncementDialog() {
  ...
  const announcement = {
    title: "🎉 New Opening!",
    subtitle: "O'O+ Billiards @ Ho Chi Minh",
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-[90%] sm:max-w-xl md:max-w-2xl lg:max-w-3xl h-[80vh] sm:h-[85vh] md:h-[80vh] my-8 sm:my-8 p-0 overflow-hidden border-2 border-[#ffd701]/30 bg-gradient-to-br from-gray-900 via-black to-gray-900">
        ...
        <div className="h-full flex flex-col">
              ...
              <div className="relative w-full h-[50%] flex-shrink-0">
                <img
                  src="/outlets/vietnam/vietnam.jpg"
                  alt="Vietnam Outlet"
                ...
                {/* Floating Badge */}
                <motion.div
                  className="absolute top-3 left-3 sm:top-4 sm:left-4 md:top-6 md:left-6 bg-gradient-to-r from-[#ffd701] to-[#ffed4e] text-black px-3 py-1.5 sm:px-4 sm:py-2 rounded-full font-bold text-xs sm:text-sm flex items-center gap-1.5 sm:gap-2 shadow-xl z-20"
              ...
              <div className="flex-1 flex flex-col justify-between p-4 sm:p-5 md:p-6">
                ...
                >
                  <Link href={announcement.ctaLink} onClick={handleClose}>
                    <button className="w-full bg-gradient-to-r from-[#ffd701] to-[#ffed4e] text-black px-4 py-2.5 rounded-lg font-bold text-sm hover:from-[#ffed4e] hover:to-[#ffd701] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl italic flex items-center justify-center gap-2" style={{ fontFamily: 'Kanit, system-ui, sans-serif' }}>
